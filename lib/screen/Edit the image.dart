...
class Edit_the_image extends StatefulWidget {
  const Edit_the_image({super.key, String? imageUrl});

  @override
  State<Edit_the_image> createState() => _Edit_the_imageState();
}

class _Edit_the_imageState extends State<Edit_the_image> {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            Get.offAll(const UserProfileSettingsPage());
          },
        ),
        centerTitle: true,
        title: const Text('تعديل الصوره الشخصيه '),
        actions: [
          if (imageBytes != null)
            IconButton(
